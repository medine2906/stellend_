...
const envSchema = z.object({
  ...
  NEXT_PUBLIC_STELLAR_NETWORK: z.enum(["TESTNET", "PUBLIC"]).catch("TESTNET"),
  NEXT_PUBLIC_HORIZON_URL: z.string().catch("https://horizon-testnet.stellar.org"),
  NEXT_PUBLIC_ANCHOR_URL: z.string().catch("https://tr-mock-anchor.fly.dev"),
  NEXT_PUBLIC_SOROBAN_RPC_URL: z.string().catch("https://soroban-testnet.stellar.org"),
